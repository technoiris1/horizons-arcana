export default function Hero() {
    return (
        <div className="w-full overflow-x-hidden relative">
            ...
            <p className="lg:hidden absolute left-1/2 -translate-x-1/2 top-[62%] text-[#1b3465] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-[family-name:var(--font-shantell-sans)] tracking-wider whitespace-nowrap px-4">
            ...
            `}</style>
            <div className="hidden lg:block absolute left-1/2 -translate-x-1/2 top-[54%] slow-float">
